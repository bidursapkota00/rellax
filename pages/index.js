...
import image from "../safety/image.png";
import centralheating from "../safety/centralheating.png";
import gas from "../safety/gas.png";
import smarthome from "../safety/smarthome.png";
import water from "../safety/water.png";

const FirstTime = () => {
  // const { inView, ref } = useInView();
  useEffect(() => {
    new Rellax(".central__image", {
      speed: 5,
    });
    new Rellax(".gas__image", {
      speed: 5,
    });
    new Rellax(".smart__image", {
      speed: 3,
    });
    new Rellax(".water__image", {
      speed: 3,
    });
    new Rellax(".first__contacts", {
      speed: 1.3,
    });
    // new Rellax(".gas_image", {
    //   speed: 5,
    // });
  });
    ...
    <>
      ...
      <section id="first-time" className="first__section">
        <div className="first__section__container">
          <div className="first__section__image">
            <div className="central__image">
              <img src="centralheating.png" />
              <div className="first__title text-primary">Central Heating</div>
            </div>
            <div className="water__image">
              <img src="water.png" />
              <div className="first__title text-primary">24*7 Water Supply</div>
            </div>
          </div>
          <div className="first__time__first">
            <div className="first__svg__image">{firstSvgImage}</div>
            <img className="first__first__image" src="image.png" />
            <div className="first__headings">
              FIRST TIME{" "}
              <span className="first__time__span text-primary">IN NEPAL</span>
            </div>
            <p className="first__description">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra
              adipiscing cursus commodo tempus id. Pharetra, ornare aenean
              adipiscing sollicitudin fringilla tortor eu dignissim.{" "}
            </p>
            <div className="first__contacts">
              <div className="wave__circle__outer">
                <div className="wave__circle__inner">
              ...
              <div className="first__contact__details">
                ...
                <div className="text-white first__contact--f">9800123456</div>
              </div>
            </div>
          </div>
          <div className="second__section__image">
